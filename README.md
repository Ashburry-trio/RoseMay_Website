https://ashburry.pythonanywhere.com or https://www.myProxyIP.com
=================================================================
...
named Bauderr). Custom www.myproxyip.com/user/<NAME>/index.html where a XDCC
...
be added to the index by emailing ashburryop@gmail.com requesting irc.servername.net
#xdcc-channel-names
to add. And I will add the channel and network to the XDCC database.
A home page will optionally contain an xdcc search
...
of the visitor for the purpose of traffic reports, weather, news, etc. What public
user scripts are turned on/off in the channels either by the user or by any user
of the proxy-server's (both or either-or). Admins of the irc channels, any sponsor
...
user. There will be no small limit to how many networks one can connect to, nor
...
speeds, tons of bandwidth (allowed bytes sent & recv'd). And lots of sponsorship with
...
hwoever I will have enough RAM for about 2,000 connections.
...
You may pay for an exclusive vCPU with a group effort. So 10 people can pay $2.50
...
by making monthly payments on the 1st of each month. First days leading to the first 1st day are free.
