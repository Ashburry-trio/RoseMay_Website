...
sess = Session()
sess.init_app(app)
gk = GateKeeper(app, ban_rule={"count":5,"window":3,"duration":60}, rate_limit_rules=[ {"count":4,"window":1, "duration":220}, {"count":12,"window":5,"duration":240}])
...
from website.search_engines import search_engines
app.register_blueprint(search_engines, url_prefix='/')
