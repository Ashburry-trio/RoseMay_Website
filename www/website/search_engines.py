...
@search_engines.route('/sitemap.xml', methods=['GET'])
def se_sitemap():
#    gk.report()
    send_from_directory('static', 'sitemap.xml')


@search_engines.route('/robots.txt', methods=['GET'])
def se_robots():
#    gk.report()
    send_from_directory('templates', 'robots.txt')
